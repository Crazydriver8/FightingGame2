...
public class DefaultSkillTreeScreen : OptionsScreen{
	...
	public override void DoFixedUpdate (){
		base.DoFixedUpdate ();
		this.DefaultNavigationSystem(this.moveCursorSound, this.selectSound, this.cancelSound, this.CancelAction);
	}
